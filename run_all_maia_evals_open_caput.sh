...
RESULTS_DIR="${ROOT_DIR}/judge_results/open_models_caput_offset"
...
for model in "${MODELS[@]}"; do
  ...
  run_eval "${model}" "ita" "caput/MAIA_ita" "simple" "${ROOT_DIR}/prompts/judge_prompt_ita.txt"
  run_eval "${model}" "eng" "caput/MAIA_eng" "simple" "${ROOT_DIR}/prompts/judge_prompt_en.txt"
  run_eval "${model}" "spa" "caput/MAIA_spa" "simple" "${ROOT_DIR}/prompts/judge_prompt_es.txt"
